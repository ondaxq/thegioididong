...
<form action="" method="post">
    <table>
        <tr>
            <td>Username</td>
            <td><input type="text" name="username" value="<?php echo $i_us['username']; ?>"></td>
        </tr>
        <tr>
            <td>Password</td>
            <td><input type="pass" name="password" value="<?php echo $i_us['pass']; ?>"></td>
        </tr>
        <tr>
            <td>Họ tên</td>
        ...
        <tr>
            ...
            <td>
                <select name="role">
                    ...
                    <option value="2" <?php echo ($i_us['role'] == 2) ? 'selected' : ''; ?>>Manager</option>
                </select>
            </td>
    ...
    <?php 
        if (isset($_POST['txtupdate'])) {
            ...
            $email = $_POST['email'];
            $role = $_POST['role'];
            $update = $get_data->update_user($username, $password, $name, $sdt, $email,$role , $id);
            if ($update) {
