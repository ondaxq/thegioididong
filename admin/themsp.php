...
<form action="" method="post" enctype="multipart/form-data">
    <table>
        ...
        <tr>
            <td>Link review sản phẩm</td>
            <td><input type="text" id="linkrv" name="linkrv" required></td>
        </tr>
        <tr>
    ...
    <?php
        ...
        if (isset($_POST['txtsub'])) {
            ...
            $insert_dienthoai = $get_data->insert_dienthoai($ten, $idhang, $hedieuhanh, $cpu, $gpu, $ram, $rom,
                $camsau, $camtruoc, $tamnen, $dophangiai, $rong, $pin , $sac,$gia, $urlhsp, $urlhts, $urlhqc,$linkrv);
            if ($insert_dienthoai) {
